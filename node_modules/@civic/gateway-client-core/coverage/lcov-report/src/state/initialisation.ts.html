...
<head>
    <title>Code coverage report for src/state/initialisation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> initialisation.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { CivicPassMessageAction } from '../types/civicPass';
...
export const civicPassStatusLookupInProgress = (state: GatewayCoreState) =&gt;
  ...
  (!state.inputs.gatewayToken.status ||
    ...
    (!state.inputs.parameters<span class="branch-0 cbranch-no" title="branch not covered" >?.d</span>isableInitialGatekeeperLookup &amp;&amp;
      (!state.inputs.gatekeeperRecord.status || state.inputs.gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus === InputStatus.IN_PROGRESS)));
&nbsp;
...
export const checkForInProgress = (state: GatewayCoreState): GatewayTokenCheckType | ComputeCheckingType =&gt;
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as GatewayTokenCheckType | ComputeCheckingType);
&nbsp;
...
export const computeInitialState = (state: GatewayCoreState): ComputeInitialStateType =&gt;
  ...
  (<span class="branch-4 cbranch-no" title="branch not covered" >state.internal?.status as ComputeInitialStateType);</span>
&nbsp;</pre></td></tr></table></pre>
