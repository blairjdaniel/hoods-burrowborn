...
<head>
    <title>Code coverage report for src/state/state.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> state.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1577x</span>
<span class="cline-any cline-yes">1577x</span>
<span class="cline-any cline-yes">1577x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1577x</span>
...
&nbsp;
  return {
    ...
    output: {
      ...
      gatewayTokenTransaction: state.inputs.gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived?.transaction,
        ...
        reset: () =&gt;
          set(
            produce((state) =&gt; {
              ...
              state.output = { ...initialOutputState, ui: state.output<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>i };
            })
          ),
      },
