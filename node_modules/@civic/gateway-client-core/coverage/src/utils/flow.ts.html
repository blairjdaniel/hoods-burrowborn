...
<head>
    <title>Code coverage report for src/utils/flow.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> flow.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1614x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1613x</span>
<span class="cline-any cline-yes">1613x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { FlowStatus, FlowType } from '../types/flow';
...
export const flowTypeFromState = (state: GatewayCoreState, computedInternalStatus: InternalGatewayStatus): FlowType =&gt; {
  if (state.inputs.gatewayToken?.received) {
    const tokenRefreshRequired = isTokenRefreshRequired({
      gatewayToken: state.inputs.gatewayToken<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived,
      tokenExpirationMarginSeconds: 0,
      forceRequireRefresh: state.inputs<span class="branch-0 cbranch-no" title="branch not covered" >?.d</span>ynamicParameters?.forceRequireRefresh,
    });
    if (
      tokenRefreshRequired ||
      state.internal.status<span class="branch-0 cbranch-no" title="branch not covered" >?.t</span>oLowerCase().includes('refresh') ||
...
&nbsp;
    ...
    if (state.output<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>lowParameters?.flowId.toLowerCase().includes(FlowType.REFRESH.toLowerCase())) {
      return FlowType.REFRESH;
    }
&nbsp;
    // handle the case where we find an ACTIVE token following the issuance flow
    if (state.output<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>lowParameters?.flowId.toLowerCase().includes(FlowType.ISSUANCE.toLowerCase())) {
...
export const flowStatusFromState = (
  ...
  if (!state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>serInteraction) {
    return undefined;
  }
&nbsp;
  ...
  if (
    ...
    (previousStatus === GatewayStatus.ACTIVE &amp;&amp; state.inputs<span class="branch-0 cbranch-no" title="branch not covered" >?.d</span>ynamicParameters?.forceRequireRefresh)
  ) {
...
&nbsp;
  if (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>serInteraction.status === UserInteractionStatus.FINISHED) {
    return FlowStatus.FINISHED;
  }
&nbsp;
  if (
    previousStatus === GatewayStatus.ACTIVE &amp;&amp;
    state.inputs.gatekeeperNetworkData<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived?.client?.tokenActiveDisplay === 'hidden' &amp;&amp;
    state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>serInteraction<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus === null
  ) {
...
&nbsp;
  if (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>serInteraction.status === UserInteractionStatus.STARTED) {
