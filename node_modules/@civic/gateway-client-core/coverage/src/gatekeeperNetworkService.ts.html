...
<head>
    <title>Code coverage report for src/gatekeeperNetworkService.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> gatekeeperNetworkService.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export const GKN_SERVICE_ENDPOINTS: Record&lt;string, string&gt; = {
...
export const getGatekeeperNetworkData = async (stage: string, gknId: string): Promise&lt;GknData&gt; =&gt; {
  ...
  if (gknData<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>d !== gknId) {
