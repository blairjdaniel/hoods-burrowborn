...
<head>
    <title>Code coverage report for src/utils/userInteraction.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> userInteraction.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { UserInteractionStatus } from '../types/userInteraction';
...
export const getUserInteractionStatusFromAction = (
  ...
  return state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>serInteraction<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus;
};
&nbsp;</pre></td></tr></table></pre>
