...
<head>
    <title>Code coverage report for src/ui.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> ui.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Store } from './state/state';
...
&nbsp;
  onShow() {
    ...
    this.gatewayCoreStore.setState((state) =&gt; {
      state.output = state.output || <span class="branch-1 cbranch-no" title="branch not covered" >{ gatewayStatus: GatewayStatus.UNKNOWN };</span>
      state.output.ui = state.output<span class="branch-0 cbranch-no" title="branch not covered" >?.u</span>i || <span class="branch-1 cbranch-no" title="branch not covered" >{ ...defaultValues };</span>
