...
<head>
    <title>Code coverage report for src/refresh.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> refresh.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  statusHasValidToken(): boolean {
    ...
    if (!gatewayToken<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>xpiryTime) {
      return false;
    }
    return !!(
      gatewayToken &amp;&amp;
