...
<head>
    <title>Code coverage report for src/state/gatewayStatus.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> gatewayStatus.ts</h1>
        <div class='clearfix'>
...
<a name='L417'></a><a href='#L417'>417</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1611x</span>
<span class="cline-any cline-yes">1611x</span>
<span class="cline-any cline-yes">1611x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
const isValidTransition = (current: InternalGatewayStatus, next: InternalGatewayStatus): boolean =&gt; {
  return transitions[current]<span class="branch-0 cbranch-no" title="branch not covered" >?.n</span>extState.includes(next);
};
&nbsp;
const performTransition = (state: GatewayCoreState) =&gt; {
  const currentStatus = state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as GatewayStatus;
...
export const computeInternalStatus = (state: GatewayCoreState): InternalGatewayStatus =&gt; {
  /**
   * handle cases where civicSign has errored, this is outside of normal state transitions
   * as civic-sign can be triggered at any time
   */
  if (state.inputs.civicSign.status === InputStatus.ERROR &amp;&amp; !state.inputs.civicPass.received) {
    return ExtendedGatewayStatus.CHAIN_SIGN_MESSAGE_ERROR;
  }
&nbsp;
