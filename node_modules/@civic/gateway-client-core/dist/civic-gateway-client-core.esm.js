...
var gatewayStatusToCivicPassAction = (_a$1 = {},
    ...
    _a$1[ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED] = CivicPassMessageAction.CREDENTIAL_EXPIRED,
    _a$1[ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START] = CivicPassMessageAction.REFRESH,
    _a$1);
...
var flowTypeFromState = function (state, computedInternalStatus) {
    ...
    if ((_a = state.inputs.gatewayToken) === null || _a === void 0 ? void 0 : _a.received) {
        ...
        if ((_h = (_g = state.output) === null || _g === void 0 ? void 0 : _g.flowParameters) === null || _h === void 0 ? void 0 : _h.flowId.toLowerCase().includes(FlowType.REFRESH.toLowerCase())) {
            return FlowType.REFRESH;
        }
        if ((_k = (_j = state.output) === null || _j === void 0 ? void 0 : _j.flowParameters) === null || _k === void 0 ? void 0 : _k.flowId.toLowerCase().includes(FlowType.ISSUANCE.toLowerCase())) {
...
var calculateRefreshStatus = function (state) {
    ...
    if ((((_b = state === null || state === void 0 ? void 0 : state.internal) === null || _b === void 0 ? void 0 : _b.status) || '') !== ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START &&
...
var transitions = (_a = {},
    ...
    _a[ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START], false), computeRefreshCredentialExpiredStatus),
    _a[ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.REFRESH_USER_INFORMATION_VALIDATED,
        ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_START_NEW_TX,
    ], false), computeRefreshStatus),
    _a);
