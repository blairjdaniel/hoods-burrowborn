...
<head>
    <title>Code coverage report for src/GatewayClientCore.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> GatewayClientCore.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { v4 as uuid } from 'uuid';
...
export const getInstanceInputObject = (input: ClientCoreInput | undefined): InstanceInputObject =&gt;
  input
    ? {
        ...input.parameters,
        ...input.chainImplementation<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>hainDetails,
      }
...
export const getInstanceName = (inputs: ClientCoreInput, instanceId: string) =&gt;
  `gcc_${inputs.parameters.wallet<span class="branch-0 cbranch-no" title="branch not covered" >?.a</span>ddress<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>ubstring(0, 4)}_${inputs.parameters<span class="branch-0 cbranch-no" title="branch not covered" >?.g</span>atekeeperNetwork<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>ubstring(0, 4)}_${
    inputs.chainImplementation<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>hainDetails<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>hainType
  }_${inputs.chainImplementation<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>hainDetails<span class="branch-0 cbranch-no" title="branch not covered" >?.c</span>hainNetwork}_${instanceId.substring(0, 4)}`;
&nbsp;
...
&nbsp;
  constructor(readonly inputs: ClientCoreInput) {
    ...
    this.log<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>etLogLevel<span class="branch-0 cbranch-no" title="branch not covered" >?.(i</span>nputs.parameters<span class="branch-0 cbranch-no" title="branch not covered" >?.o</span>ptions?.logLevel || DEFAULT_LOG_LEVEL);
...
&nbsp;
  public static getSingleInstance(inputs: ClientCoreInput): GatewayClientCore | undefined {
    ...
    if (!hasRequiredInputs(inputs)) {
      ...
      GatewayClientCore.currentInstance<span class="branch-0 cbranch-no" title="branch not covered" >?.a</span>bort();
