...
<span class="cline-any cline-yes">3398x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">661x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { LogLevel } from 'src/types/log';
...
export const prefixLogger = (prefix: string, globalPrefix = 'GatewayClientCore'): LoggingInterface =&gt; {
  return {
    setLogLevel: (logLevel: LogLevel) =&gt; localLogger<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>etLogLevel<span class="branch-0 cbranch-no" title="branch not covered" >?.(l</span>ogLevel),
