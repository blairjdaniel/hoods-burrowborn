...
<head>
    <title>Code coverage report for src/logger/provider.logger.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/logger</a> provider.logger.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">3865x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { LogLevel } from '../types/log';
&nbsp;
...
&nbsp;
  warn(message: string, object?: unknown): void {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (allowLogging(this.logLevel, LogLevel.WARN)) this.logger.warn(message, object);
  }
&nbsp;
  error(message: string, exception?: unknown): void {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (allowLogging(this.logLevel, LogLevel.ERROR)) this.logger.error(message, exception);
  }
}
&nbsp;</pre></td></tr></table></pre>
