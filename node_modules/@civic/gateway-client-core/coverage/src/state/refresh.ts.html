...
<head>
    <title>Code coverage report for src/state/refresh.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> refresh.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GatewayCoreState } from '../types/gatewayCore';
...
export const computeRefreshRequested = (state: GatewayCoreState): ComputeRefreshRequestedReturnType =&gt;
  ...
  (<span class="branch-2 cbranch-no" title="branch not covered" >state.internal?.status as InternalGatewayStatus);</span>
&nbsp;
...
export const computeRefreshInReview = (state: GatewayCoreState): ComputeRefreshInReviewReturnType =&gt;
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as InternalGatewayStatus);
&nbsp;
...
export const computeRefreshStartPreApprovedTransaction = (
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as
    | TokenNotRefreshRequiredReturnType
    | ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_REQUEST_NEW_TX);
&nbsp;</pre></td></tr></table></pre>
