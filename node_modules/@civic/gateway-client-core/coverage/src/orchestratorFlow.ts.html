...
<head>
    <title>Code coverage report for src/orchestratorFlow.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> orchestratorFlow.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  setGatekeeperClientFlowId() {
    ...
    this.gatekeeperClient.setFlowId(fullState.output<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>lowParameters<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>lowId);
  }
}
&nbsp;</pre></td></tr></table></pre>
