(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    (function (ExtendedGatewayStatus) {
        ...
        ExtendedGatewayStatus["REFRESH_CREDENTIAL_EXPIRED"] = "REFRESH_CREDENTIAL_EXPIRED";
        ExtendedGatewayStatus["REFRESH_CREDENTIAL_EXPIRED_START"] = "REFRESH_CREDENTIAL_EXPIRED_START";
    ...
    (function (FlowType) {
        ...
        FlowType["REFRESH_EXPIRED_CREDENTIAL"] = "refreshExpiredCredential";
    ...
    (function (CivicPassMessageAction) {
        ...
        CivicPassMessageAction["CREDENTIAL_EXPIRED"] = "credentialExpired";
    ...
    var gatewayStatusToCivicPassAction = (_a$1 = {},
        ...
        _a$1[exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED] = CivicPassMessageAction.CREDENTIAL_EXPIRED,
        _a$1[exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START] = CivicPassMessageAction.REFRESH,
        _a$1);
    var internalToOutputGatewayStatus = function (internalStatus) {
        switch (internalStatus) {
            ...
            case exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED:
                return exports.GatewayStatus.REFRESH_TOKEN_REQUIRED;
            case exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START:
                return exports.GatewayStatus.REFRESH_TOKEN_REQUIRED;
    ...
    var flowTypeFromState = function (state, computedInternalStatus) {
        ...
        if ((_a = state.inputs.gatewayToken) === null || _a === void 0 ? void 0 : _a.received) {
            ...
            if (tokenRefreshRequired && ((_e = state.inputs.dynamicParameters) === null || _e === void 0 ? void 0 : _e.credentialExpired)) {
                return exports.FlowType.REFRESH_EXPIRED_CREDENTIAL;
            }
            if (tokenRefreshRequired ||
                ((_f = state.internal.status) === null || _f === void 0 ? void 0 : _f.toLowerCase().includes('refresh')) ||
                computedInternalStatus.toLowerCase().includes('refresh')) {
                return exports.FlowType.REFRESH;
            }
            if ((_h = (_g = state.output) === null || _g === void 0 ? void 0 : _g.flowParameters) === null || _h === void 0 ? void 0 : _h.flowId.toLowerCase().includes(exports.FlowType.REFRESH.toLowerCase())) {
                return exports.FlowType.REFRESH;
            }
            if ((_k = (_j = state.output) === null || _j === void 0 ? void 0 : _j.flowParameters) === null || _k === void 0 ? void 0 : _k.flowId.toLowerCase().includes(exports.FlowType.ISSUANCE.toLowerCase())) {
    ...
    var getScopeRequestIdFromGatekeeperResponse = function (gatekeeperRecord) {
        var _a, _b, _c, _d;
        return (((_a = getPendingRequestFromGatekeeperRecord(gatekeeperRecord)) === null || _a === void 0 ? void 0 : _a.presentationRequestId) ||
            ((_c = (_b = gatekeeperRecord === null || gatekeeperRecord === void 0 ? void 0 : gatekeeperRecord.received) === null || _b === void 0 ? void 0 : _b.payload) === null || _c === void 0 ? void 0 : _c.presentationRequestId) ||
            ((_d = gatekeeperRecord === null || gatekeeperRecord === void 0 ? void 0 : gatekeeperRecord.received) === null || _d === void 0 ? void 0 : _d.presentationRequestId));
    };
    ...
    var refreshCredentialRequired = function (gatekeeperRecord) {
        var _a, _b;
        return !!((_b = (_a = gatekeeperRecord === null || gatekeeperRecord === void 0 ? void 0 : gatekeeperRecord.received) === null || _a === void 0 ? void 0 : _a.payload) === null || _b === void 0 ? void 0 : _b.credentialExpired);
    };
    var calculateRefreshStatus = function (state) {
        ...
        if ((((_b = state === null || state === void 0 ? void 0 : state.internal) === null || _b === void 0 ? void 0 : _b.status) || '') !== exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START &&
            refreshCredentialRequired(state.inputs.gatekeeperRecord)) {
            return exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED;
        }
    ...
    var calculateExpiredCredentialStatus = function (state) {
        var _a;
        if (((_a = state.inputs.civicPass.received) === null || _a === void 0 ? void 0 : _a.action) === CivicPassMessageAction.CREDENTIAL_EXPIRED &&
            state.inputs.civicPass.received.event === CivicPassMessageEventResult.SUCCESS) {
            return exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START;
        }
    };
    ...
    var computeRefreshCredentialExpiredStatus = function (state) {
        var _a;
        return tokenNotRefreshRequired(state) ||
            statusIfGatekeeperRecordRejected(state) ||
    ...
    var transitions = (_a = {},
        ...
        _a[exports.GatewayStatus.REFRESH_TOKEN_REQUIRED] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
            ...
            exports.ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_START_NEW_TX,
            exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED,
        ...
        _a[exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START], false), computeRefreshCredentialExpiredStatus),
        _a[exports.ExtendedGatewayStatus.REFRESH_CREDENTIAL_EXPIRED_START] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
            exports.ExtendedGatewayStatus.REFRESH_USER_INFORMATION_VALIDATED,
            exports.ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_START_NEW_TX,
        ], false), computeRefreshStatus),
        _a);
    ...
    var VERSION = '@civic/gateway-client-core:1.1.3-beta.4';
    ...
    var computeFlowParameters = function (state, computedInternalStatus) {
        ...
        var feeFromGatekeeper = ((_w = (_v = (_u = state.inputs.gatekeeperRecord) === null || _u === void 0 ? void 0 : _u.received) === null || _v === void 0 ? void 0 : _v.payload) === null || _w === void 0 ? void 0 : _w.feeAmountUSDCents) ||
            ((_y = (_x = state.inputs.gatekeeperRecord) === null || _x === void 0 ? void 0 : _x.received) === null || _y === void 0 ? void 0 : _y.feeAmountUSDCents);
        var feeAmountUSDCents = feeFromGatekeeper !== undefined ? feeFromGatekeeper : (_0 = (_z = state.output) === null || _z === void 0 ? void 0 : _z.flowParameters) === null || _0 === void 0 ? void 0 : _0.feeAmountUSDCents;
        return __assign(__assign(__assign({ action: action, flowId: flowId, ownerSigns: ownerSigns, errorCode: errorCode, flowType: flowTypeFromState(state, computedInternalStatus) }, (payload ? { payload: payload } : {})), { redirectUrl: (_1 = state.inputs.parameters) === null || _1 === void 0 ? void 0 : _1.redirectUrl, networkAddress: (_2 = state.inputs.parameters) === null || _2 === void 0 ? void 0 : _2.gatekeeperNetwork, wallet: state.inputs.parameters.wallet.address, chain: (_3 = state.internal.chainDetails) === null || _3 === void 0 ? void 0 : _3.chainType, chainNetwork: (_4 = state.internal.chainDetails) === null || _4 === void 0 ? void 0 : _4.chainNetwork, did: (_5 = state.internal.ownerDids) === null || _5 === void 0 ? void 0 : _5[0], gatekeeperSendsTransaction: state.inputs.parameters.gatekeeperSendsTransaction, partnerAppId: state.inputs.parameters.partnerAppId, referrer: state.inputs.parameters.referrer, domain: state.inputs.parameters.domain, instanceId: state.internal.instanceId, hideWalletPrompts: state.inputs.parameters.payer && state.inputs.parameters.payer !== state.inputs.parameters.wallet.address
                ? (_6 = state.inputs.parameters.options) === null || _6 === void 0 ? void 0 : _6.hideWalletPrompts
                : undefined, signedTx: (_8 = (_7 = state.internal) === null || _7 === void 0 ? void 0 : _7.chainTransaction) === null || _8 === void 0 ? void 0 : _8.sentTxId, civicClient: ((_10 = (_9 = state.inputs) === null || _9 === void 0 ? void 0 : _9.parameters) === null || _10 === void 0 ? void 0 : _10.xCivicClientHeader) || VERSION, stage: (_12 = (_11 = state.inputs) === null || _11 === void 0 ? void 0 : _11.parameters) === null || _12 === void 0 ? void 0 : _12.stage, credentialExpired: !!((_15 = (_14 = (_13 = state.inputs.gatekeeperRecord) === null || _13 === void 0 ? void 0 : _13.received) === null || _14 === void 0 ? void 0 : _14.payload) === null || _15 === void 0 ? void 0 : _15.credentialExpired) }), (feeAmountUSDCents !== undefined ? { feeAmountUSDCents: feeAmountUSDCents } : {}));
    };
    ...
    var computeState = function (state) {
        ...
        var presentationRequestId = getScopeRequestIdFromGatekeeperResponse(state.inputs.gatekeeperRecord);
        return {
            ...
            output: __assign(__assign({}, state.output), { ui: ui, flowParameters: flowParameters, flowState: {
                ...
                }, gatewayStatus: internalToOutputGatewayStatus(computedInternalStatus), gatewayToken: state.inputs.gatewayToken.received || undefined, gatewayTokenTransaction: (_f = (_e = state.inputs.gatekeeperRecord) === null || _e === void 0 ? void 0 : _e.received) === null || _f === void 0 ? void 0 : _f.transaction, pendingRequests: presentationRequestId ? { presentationRequestId: presentationRequestId } : undefined }),
        };
    };
    ...
    var GatewayClientCore = (function () {
        ...
        GatewayClientCore.prototype.reset = function () {
