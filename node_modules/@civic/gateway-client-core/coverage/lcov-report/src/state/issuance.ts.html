...
<head>
    <title>Code coverage report for src/state/issuance.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> issuance.ts</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">87.31% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>303/347</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GatewayCoreState, GatewayInput } from '../types/gatewayCore';
...
export const calculateIssuanceStartPreApprovedTransaction = (
  ...
  | undefined =&gt; {
  const civicPassEvent = state.inputs.civicPass<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived;
  if (
    civicPassEvent?.action === CivicPassMessageAction.START_PRE_APPROVED_TRANSACTION &amp;&amp;
    civicPassEvent<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>vent === CivicPassMessageEventResult.SUCCESS &amp;&amp;
    civicPassEvent<span class="branch-0 cbranch-no" title="branch not covered" >?.p</span>ayload !== undefined
  ) {
    return payerIsWalletOwner(state)
      ? ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX
      : <span class="branch-1 cbranch-no" title="branch not covered" >ExtendedGatewayStatus.ISSUANCE_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX;</span>
  }
};
&nbsp;
...
export const hasExistingDataCollectionProcessInProgress = (civicPassEvent: CivicPassMessageResponse | null): boolean =&gt;
  (civicPassEvent?.action === CivicPassMessageAction.STATUS &amp;&amp;
    civicPassEvent<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>vent === CivicPassMessageEventResult.SUCCESS &amp;&amp;
    civicPassEvent.payload<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus !== ValidationStatus.NOT_FOUND) ||
  (civicPassEvent?.action === CivicPassMessageAction.ISSUANCE &amp;&amp;
    civicPassEvent<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>vent === CivicPassMessageEventResult.IN_PROGRESS);
&nbsp;
...
&nbsp;
  if (state.inputs.parameters<span class="branch-0 cbranch-no" title="branch not covered" >?.p</span>ayer) {
    ...
    if (
      ...
      civicPassEvent?.action !== CivicPassMessageAction.ISSUANCE &amp;&amp;
      !gatekeeperRecord.received<span class="branch-0 cbranch-no" title="branch not covered" >?.t</span>ransaction
    ) {
    ...
    if (gatekeeperRecord.received<span class="branch-0 cbranch-no" title="branch not covered" >?.t</span>ransaction) {
...
export const calculateFromGatekeeperIssuanceRequested = (
  ...
  if (
    ...
    (gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived?.state === GatekeeperAPIStatus.REQUESTED ||
      gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus === InputStatus.IN_PROGRESS)
  ) {
    return state.inputs.parameters<span class="branch-0 cbranch-no" title="branch not covered" >?.p</span>ayer &amp;&amp; payerIsWalletOwner(state)
      ? ExtendedGatewayStatus.ISSUANCE_CLIENT_PAYER_REQUESTED
      : GatewayStatus.IN_REVIEW;
  }
};
...
export const calculateIssuanceRequestedDataCollectionRestart = (
  ...
  if (
    ...
    if (gatewayStatusFromValidationProcess === GatewayStatus.USER_INFORMATION_VALIDATED) {
      return civicPassEvent.payload ? GatewayStatus.USER_INFORMATION_VALIDATED : <span class="branch-1 cbranch-no" title="branch not covered" >GatewayStatus.NOT_REQUESTED;</span>
    }
...
export const computeIssuanceDataCollectionRestart = <span class="fstat-no" title="function not covered" >(</span>
  state: GatewayCoreState
): ComputeIssuanceDataCollectionRestartType =&gt;
<span class="cstat-no" title="statement not covered" >  statusFromGatewayTokenIfExists(state) ||</span>
...
export const computeIssuanceRequested = (state: GatewayCoreState): ComputeIssuanceRequestedType =&gt;
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as ComputeIssuanceRequestedType);
&nbsp;
export const computeIssuanceAwaitingOnChainToken = (
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as GatewayTokenCheckType | CalculateFromIssuanceAwaitingOnChainReturn);
&nbsp;
...
export const computeIssuanceInReview = (state: GatewayCoreState): ComputeIssuanceInReviewType =&gt;
  ...
  (<span class="branch-3 cbranch-no" title="branch not covered" >state.internal?.status as ComputeIssuanceInReviewType);</span>
&nbsp;
...
&nbsp;
  ...
  if (!gatekeeperRecord?.received || gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tate === GatekeeperAPIStatus.NOT_REQUESTED) {
    if (hasExistingDataCollectionProcessInProgress(civicPassEvent)) {
      const gatewayStatusFromValidationProcess =
        validationProcessToGatewayStatus[civicPassEvent<span class="branch-0 cbranch-no" title="branch not covered" >?.p</span>ayload<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as CheckValidationStatusType];
&nbsp;
...
&nbsp;
  ...
  if (gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tate === GatekeeperAPIStatus.REQUESTED) {
...
&nbsp;
    if (state.inputs.parameters?.payer) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (
        gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus === InputStatus.COMPLETE &amp;&amp;
        civicPassEvent<span class="branch-0 cbranch-no" title="branch not covered" >?.a</span>ction !== CivicPassMessageAction.ISSUANCE &amp;&amp;
        !gatekeeperRecord.received<span class="branch-0 cbranch-no" title="branch not covered" >?.t</span>ransaction
      ) {
        return ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION;
      }
...
export const computeIssuanceStatus = (state: GatewayCoreState): GatewayTokenCheckType | CalculateIssuanceStatusReturn =&gt;
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as GatewayTokenCheckType | CalculateIssuanceStatusReturn);
&nbsp;
export const computeIssuanceStartPreApprovedTransaction = (
  ...
  (state.internal<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tatus as GatewayTokenCheckType | ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX);
&nbsp;</pre></td></tr></table></pre>
