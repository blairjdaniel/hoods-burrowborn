...
<head>
    <title>Code coverage report for src/listeners.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> listeners.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// A Class to register the different listeners we need to orchestrate the different parts of the gateway
...
&nbsp;
      ...
      if (response.data<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>nstanceId !== this.instanceId) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (response.data<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>nstanceId &amp;&amp; response.data.source !== '@devtools-page') {
...
&nbsp;
  registerCivicSignListener(onMessage: (data: CivicSignEventTypeRequestMessage) =&gt; void) {
    const handler = (response: MessageEvent&lt;CivicSignEventTypeRequestMessage&gt;) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!response.data) {
<span class="cstat-no" title="statement not covered" >        this.log.error('No data in response');</span>
<span class="cstat-no" title="statement not covered" >        return; </span>// Exit if there is no data in the response
      }
&nbsp;
      // Checking instanceId matching
      if (response.data<span class="branch-0 cbranch-no" title="branch not covered" >?.i</span>nstanceId !== this.instanceId) {
