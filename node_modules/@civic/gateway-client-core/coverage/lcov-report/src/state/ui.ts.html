...
<head>
    <title>Code coverage report for src/state/ui.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> ui.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { objectToURLParams } from '../utils/url';
...
const getUrl = (state: GatewayCoreState, flowParameters: FlowParameters | undefined): string | undefined =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!state.inputs<span class="branch-0 cbranch-no" title="branch not covered" >?.p</span>arameters<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tage) {
<span class="cstat-no" title="statement not covered" >    return undefined;</span>
  }
  const url = new URL(getCivicPassEndpoint(state.inputs.parameters.stage));
  const urlParams = objectToURLParams(flowParameters || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
