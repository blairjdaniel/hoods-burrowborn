...
<head>
    <title>Code coverage report for src/state/stateMapping.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> stateMapping.ts</h1>
        <div class='clearfix'>
...
export const internalToOutputGatewayStatus = (internalStatus: InternalGatewayStatus): GatewayStatus =&gt; {
  switch (internalStatus) {
    ...
    case ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX:
      return GatewayStatus.IN_REVIEW;
<span class="branch-23 cbranch-no" title="branch not covered" >    case ExtendedGatewayStatus.ISSUANCE_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX:</span>
<span class="cstat-no" title="statement not covered" >      return GatewayStatus.IN_REVIEW;</span>
    case ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_REQUEST_NEW_TX:
      return GatewayStatus.IN_REVIEW;
<span class="branch-25 cbranch-no" title="branch not covered" >    case ExtendedGatewayStatus.REFRESH_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX:</span>
<span class="cstat-no" title="statement not covered" >      return GatewayStatus.IN_REVIEW;</span>
    default:
