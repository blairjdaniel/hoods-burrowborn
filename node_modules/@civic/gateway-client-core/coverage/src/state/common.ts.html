...
<head>
    <title>Code coverage report for src/state/common.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/state</a> common.ts</h1>
        <div class='clearfix'>
...
<a name='L123'></a><a href='#L123'>123</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { isTokenRefreshRequired } from '../utils/expiry';
...
export const statusIfGatekeeperRecordRejected = (
  ...
  const recordState = gatekeeperRecord<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived?.state;
  switch (recordState) {
    case GatekeeperAPIStatus.ISSUED_EXPIRED:
      ...
      return gatewayToken<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>eceived ? undefined : GatewayStatus.ERROR;
